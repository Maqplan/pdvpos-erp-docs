<!-- NAVIGATION:START -->
---
[README Principal](../README.md) | [Índice dos Conceitos](README.md) | [Anterior](07-O-QUE-E-SITEF.md) | [Próximo](09-O-QUE-E-INTENT.md)
---
> **Caminho:** [Início](../README.md) / [Conceitos](README.md) / O que é Provider Android
<!-- NAVIGATION:END -->
...
Agora conheceremos o **Android Intent**, outro mecanismo de comunicação suportado pelo ConnectTEF para integração entre aplicações Android.
...
- [Integração via Provider](../03-INTEGRACOES/03-INTEGRACAO-VIA-PROVIDER.md)
- [Integração Android](../03-INTEGRACOES/11-INTEGRACAO-ANDROID.md)

---
**Navegação:** [Anterior](07-O-QUE-E-SITEF.md) | [Próximo](09-O-QUE-E-INTENT.md)
